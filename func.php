<?php  
    ...
    function get_mem_id($search)
    {
        //echo $search;
        $data = array();
        $error = 0;
        /**if($config['lite'] == 'worldoftanks.com'){
        $special = '/community/accounts/';
        }else{
        $special = ' /uc/accounts/';    
        }   **/
        $special = ' /uc/accounts/';
